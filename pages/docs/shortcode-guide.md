...
excerpt: "Vollständige Anleitung zur Verwendung aller ChurchTools Suite Shortcodes mit Beispielen und Parametern"
...
- [Shortcode Reference](/docs/shortcode-reference/) - Schnellreferenz aller Shortcodes
- [Template Documentation](/docs/templates/) - Template-Entwicklung
- [Installation Guide](/docs/installation/) - Plugin installieren
- [Configuration Guide](/docs/configuration/) - Plugin konfigurieren
